...
namespace GestionEventosAcademicos.NewApi.Controllers
{
    ...
    public class ParticipantesController : ControllerBase
    {
        ...
        {
            return await _context.Participantes.Include(p=>p.Inscripciones).ToListAsync();
        }
        ...
        {
            var participante = await _context.Participantes.Include(p => p.Inscripciones).FirstOrDefaultAsync(p =>p.Idparticipante == id);
